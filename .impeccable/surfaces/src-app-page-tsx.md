...
related_targets: ["src/components/landing-page.tsx","src/components/landing-hero.tsx","src/components/landing-demo.tsx","src/components/landing-faq.tsx","src/components/landing.module.css"]
---

## Portée et mode

Page publique `/`, mode Persuade. Elle parle à la personne active qui pilote le
budget d’un foyer aux revenus confortables, avec des charges et des projets.
Ce ciblage est une hypothèse de lancement, pas une demande validée. Les écrans
...
ce qu’il restera. Sur fond forêt, la démonstration alterne « Votre mois »,
...
La présentation est une sélection de captures de vrais composants avec des données
de démonstration, et non une vidéo ou un budget interactif. Le choix met à jour le
...
Sur téléphone, promesse et action précèdent l’image. La navigation de sections
s’efface, la connexion reste visible. La vue du mois remplace le grand tableau par
