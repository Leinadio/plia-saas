    ...
    >
      ...
      >
        <Image
          ...
          fill
          sizes="58vw"
          className="object-cover object-[66%_center] opacity-80 saturate-[0.72] contrast-[1.08]"
        />
        <div className="absolute inset-0 bg-sarcelle/15 mix-blend-color" />
        <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-[var(--landing-problem-bg)] to-transparent" />
        <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[var(--landing-problem-bg)] to-transparent" />
      </div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(270deg, var(--landing-problem-bg) 0%, var(--landing-problem-bg) 39%, transparent 76%)",
        }}
      />
      <DotPattern
        width={28}
        height={28}
        cr={0.65}
        className="text-white/10 [mask-image:linear-gradient(to_right,transparent,black_78%)]"
      />

      <div className="relative z-10 mx-auto grid max-w-7xl items-center px-5 py-20 sm:px-8 lg:min-h-[38rem] lg:grid-cols-[0.92fr_1.08fr] lg:px-10 lg:py-28">
        <div
          className="relative -mx-5 -mt-20 mb-12 aspect-[5/4] overflow-hidden sm:-mx-8 lg:hidden"
          style={{
            WebkitMaskImage:
        ...
        >
          <Image
            ...
            fill
            sizes="100vw"
            className="object-cover object-[66%_center] opacity-85 saturate-[0.72] contrast-[1.08]"
          />
          <div className="absolute inset-0 bg-sarcelle/15 mix-blend-color" />
        </div>

        <div aria-hidden className="hidden lg:block" />
        <div className="mx-auto max-w-2xl text-center lg:justify-self-center">
